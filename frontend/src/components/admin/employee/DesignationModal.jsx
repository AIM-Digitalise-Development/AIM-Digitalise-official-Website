...
const DesignationModal = ({ isOpen, onClose, onSave, editingDesignation, departments, loading }) => {
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-bold mt-0.5">
              {editingDesignation ? 'Modify designation details' : 'Create a new role designation under a department'}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm text-slate-700 focus:outline-none focus:border-[#38b34a] focus:ring-2 focus:ring-[#38b34a]/10 transition-all font-sans"
            >
