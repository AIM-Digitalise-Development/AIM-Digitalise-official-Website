  ...
  return (
    <section className="relative py-24 overflow-hidden bg-slate-950 border-t border-slate-900">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[500px] h-[250px] bg-indigo-500/6 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[200px] bg-purple-500/6 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative container-custom z-10">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-400 text-xs font-semibold uppercase tracking-widest mb-4">
            Our Purpose
          </span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-14">
          {/* Mission */}
          <motion.div
            className="relative group rounded-3xl p-8 overflow-hidden bg-gradient-to-br from-indigo-500/10 to-purple-500/5 border border-indigo-500/25 shadow-xl hover:shadow-indigo-500/10 transition-shadow duration-300"
          ...
          >
            {/* Corner deco */}
            <div className="absolute top-0 right-0 w-48 h-48 bg-indigo-500/5 rounded-full blur-2xl translate-x-1/2 -translate-y-1/2" />
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-indigo-500/[0.03] rounded-3xl" />
          ...
          {/* Vision */}
          <motion.div
            className="relative group rounded-3xl p-8 overflow-hidden bg-gradient-to-br from-purple-500/10 to-pink-500/5 border border-purple-500/25 shadow-xl hover:shadow-purple-500/10 transition-shadow duration-300"
            initial={{ opacity: 0, x: 30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            {/* Corner deco */}
            <div className="absolute top-0 right-0 w-48 h-48 bg-purple-500/5 rounded-full blur-2xl translate-x-1/2 -translate-y-1/2" />
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-purple-500/[0.03] rounded-3xl" />
            ...
            <div className="relative">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <span className="text-purple-400 text-xs font-bold uppercase tracking-widest">Our Vision</span>
