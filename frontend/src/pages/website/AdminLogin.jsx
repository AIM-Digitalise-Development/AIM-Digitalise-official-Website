...
export default function AdminLogin() {
  ...
  return (
    <>
      <Helmet>
        <title>AIM Digitalise | Admin Login</title>
        <meta name="description" content="Sign in to AIM Digitalise Admin Portal." />
      </Helmet>
      ...
      <div className="h-screen bg-aim-navy flex flex-col relative overflow-hidden">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          ...
          />
          <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-aim-purple/10 rounded-full blur-[140px] animate-pulse" style={{ animationDuration: '8s' }} />
        ...
        <main className="relative z-10 flex-1 flex items-center justify-center px-4 py-16">
          <div className="w-full max-w-md">
            ...
            <div className="relative rounded-3xl border border-white/10 bg-aim-navy-card/75 backdrop-blur-2xl p-8 sm:p-10 shadow-2xl shadow-black/80 transition-all duration-300 -translate-y-1.5">
              ...
              <div className="absolute top-0 right-0 -mr-16 -mt-16 w-48 h-48 bg-aim-purple/15 rounded-full blur-3xl pointer-events-none" />
              ...
              <div className="relative z-10 text-center mb-8">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-4 bg-aim-purple/15 border border-aim-purple/30 text-aim-purple-light">
                  <span className="w-1.5 h-1.5 rounded-full bg-aim-purple animate-ping" />
                  ADMIN ACCESS
                </div>
                ...
                <p className="text-xs text-aim-copy-muted leading-relaxed max-w-[290px] mx-auto">
                  Administrative terminal. Access users, system settings, and analytics.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                ...
                <div className="pt-3">
                  <Button
                    type="submit"
                    variant="primary"
                    className="w-full py-3.5 text-sm font-black uppercase tracking-wider rounded-xl shadow-lg transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] cursor-pointer bg-gradient-to-r from-aim-purple to-aim-purple/80 text-white shadow-aim-purple/20 hover:shadow-aim-purple/40"
