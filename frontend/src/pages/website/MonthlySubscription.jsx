...
const subscriptionPlans = [
  ...
  },
  {
    ...
    customization: `Custom exam grading rubrics, parent portal access, Premium catalogue, dynamic ID card generation, and online admission application portals.`,
    complimentary: `Get the Employee Self-Service (ESS) software absolutely free for one year, complete with individual employee logins for attendance and leave management. After the first year, the price will be ₹199/month, instead of ₹27,500 on a monthly subscriptions basis.`,
    support: `Dedicated Relationship Manager will be Assigned`
  },
  {
...
const MonthlySubscription = () => {
  const [activeCategory, setActiveCategory] = useState('nexgn')
  const [activePlanId, setActivePlanId] = useState(9)
            ...
            {paymentStep !== 'idle' && (
              <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 overflow-y-auto">
                ...
                <motion.div
                  ...
                  className="relative w-full max-w-5xl bg-slate-900 border border-white/10 rounded-3xl p-4 sm:p-6 shadow-2xl z-10 max-h-[96vh] overflow-y-auto text-left"
                >
                  {/* Close button */}
                  <button
                    type="button"
                  ...
                  <div className="space-y-6 relative z-10">
                    ...
                    {paymentStep === 'form' && (
                      <>
                        {/* Header */}
                        <div className="flex items-center justify-between pb-3 border-b border-aim-border">
                          <div>
                            <span className="text-[10px] font-black tracking-widest text-aim-gold uppercase bg-aim-gold/10 px-3 py-1 rounded-full border border-aim-gold/20">
                              COMPLETE REGISTRATION
                            </span>
                            <h3 className="text-lg font-black text-aim-copy tracking-tight mt-1.5 animate-pulse">
                              {activePlan.name}
                            </h3>
                        ...
                        <form onSubmit={handleCheckoutSubmit} className="space-y-3">
                          ...
                          <div className="grid md:grid-cols-2 gap-4 md:gap-6 items-start">
                            ...
                            <div className="space-y-3">
                              <div>
                                <h4 className="text-[10px] font-black text-aim-copy-muted uppercase tracking-widest mb-1.5">Billing Details</h4>
                                <div className="grid sm:grid-cols-2 gap-2.5">
                                  ...
                                  {isInstitutePro ? (
                                    <>
                                      ...
                                      <div className="space-y-1">
                                        <label className="text-[9px] font-bold text-aim-copy-muted uppercase tracking-widest block">
                                          Short Name <span className="text-aim-gold">*</span>
                                        </label>
                                        <input
                                          type="text"
                                      ...
                                      <div className="space-y-1">
                                        <label className="text-[9px] font-bold text-aim-copy-muted uppercase tracking-widest block">
                                          Current Session <span className="text-aim-gold">*</span>
                                        </label>
                                        <input
                                          type="text"
                                          name="school_session"
                            ...
                            <div className="space-y-3">
                              <div>
                                <h4 className="text-[10px] font-black text-aim-copy-muted uppercase tracking-widest mb-1.5">Address & RM Details</h4>
                                <div className="grid sm:grid-cols-2 gap-2.5">
                                  <div className="space-y-1">
                                    <label className="text-[9px] font-bold text-aim-copy-muted uppercase tracking-widest block">
