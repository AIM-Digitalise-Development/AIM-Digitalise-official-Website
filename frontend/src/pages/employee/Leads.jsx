                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="text-left space-y-1.5">
                          ...
                          >
                            📅 {lead.follow_up_date
                              ? formatFollowUpDisplay(lead.follow_up_date)
                              : 'Set Date'}
                          </button>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <option value="general_client" className="bg-[#13151f]">
                        General Services
                      </option>
                    </select>
                  </div>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/10 pb-2.5">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="bg-white/5 border border-white/10 rounded-xl px-3 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-[#38b34a] w-full sm:w-48"
                          />
                          {serviceSearchTerm && (
                            <button
                              type="button"
