  ...
  const handleSaveQuotation = async (shouldSendEmail = false) => {
    ...
    try {
      ...
      if (editingQuotationId) {
        res = await updateEmployeeQuotation(editingQuotationId, payload)
      } else {
        res = await createEmployeeQuotation(selectedGenClient.id, payload)
      }
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-center pb-4 border-b border-white/10 gap-3">
                    <div>
                      ...
                      <div className="text-xs text-gray-400 font-medium mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1">
                        ...
                        <span>|</span>
                        <span>Executive: <strong className="text-gray-300">{selectedGenClient?.sold_by_name || selectedGenClient?.sold_by || employeeName}</strong></span>
                        <span>|</span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                          ...
                          <div>
                            <label className="text-[10px] font-bold text-gray-400 block mb-1">
                              Payment Terms <span className="text-rose-400 font-bold">*</span>
                            </label>
                            <div className="space-y-1.5">
                              <select
                                ...
                                className="w-full bg-[#151722] border border-white/10 rounded-xl px-3 py-1.5 text-xs font-bold text-gray-200 focus:border-[#38b34a]"
                              >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-slate-50/80 rounded-2xl p-4 sm:p-5 border border-slate-200/80 text-xs">
                    ...
                    <div className="space-y-1 sm:border-l sm:border-slate-200 sm:pl-6">
                      ...
                      <p className="text-slate-700">
                        Sold / Prepared By: <strong>{viewingQuotationDoc.client?.sold_by_name || 'Executive Sales Team'}</strong>
                      </p>
                      <p className="text-slate-700">
