    ...
    <div className="space-y-6 select-none animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-white/5">
        <div>
          ...
          <p className="text-[12px] text-gray-500 mt-0.5 font-medium">AIM Digitalise Pvt. Ltd. · FY 2026-2027 · <span className="text-yellow-400">Demo Mode</span></p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 rounded-2xl p-5" style={{ background: '#1a1d2b', border: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="flex items-center justify-between mb-5">
            <h3 className="text-[14px] font-black text-white">Revenue Analytics — FY 2025-26</h3>
            <span className="text-[11px] font-bold text-gray-500">₹ in thousands</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Clients */}
        <div className="rounded-2xl p-5" style={{ background: '#1a1d2b', border: '1px solid rgba(255,255,255,0.06)' }}>
          <h3 className="text-[14px] font-black text-white flex items-center gap-2 mb-4">
        ...
        <div className="rounded-2xl p-5" style={{ background: '#1a1d2b', border: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div className="space-y-0.5 max-h-60 overflow-y-auto pr-1">
            {activities.map((a, i) => (
              <div key={i} className="flex items-start justify-between gap-3 py-2.5 px-3 rounded-xl hover:bg-white/5 transition-colors">
                <div>
      ...
      <div className="rounded-2xl p-5" style={{ background: '#1a1d2b', border: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        {showAddTask && (
          <div className="mb-4 flex gap-2 flex-wrap">
            ...
            <button onClick={addTask} className="px-4 py-2 rounded-lg text-[12px] font-bold cursor-pointer" style={{ background: '#38b34a', color: '#000' }}>Add</button>
