...
import { C as useQueryClient, z as onlineManager } from "./modern-XAwwoGF2.js";
import { t as require_jsx_runtime } from "./jsx-runtime-gvUgNymC.js";
import { G as setupStyleSheet, I as mergeProps, P as lazy, V as render, m as createComponent, x as createSignal } from "./Q7GRFEEB-CpXSFrKU.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./VKXKX7EQ-i4oBzeW_.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./ZUJJ2RGI-BHUfpRXM.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
